  ...
  <table>
    <tr>
      <td width="50%" valign="top">
        <div align="center">
          ...
          <p align="center">
            <a href="https://github.com/joee231/social_media_project">
              <img src="https://custom-icon-badges.demolab.com/badge/VIEW-CODE-7C3AED?style=for-the-badge&logo=github&logoColor=white&labelColor=1a1b27" alt="Source Code" />
            </a>
          </p>
        </div>
        
        <p align="center"><strong>🔥 Flutter • Firebase • Clean Architecture</strong></p>
        ...
        <ul>
          <li>📊 Scalable platform for <strong>100+ concurrent users</strong></li>
          <li>💬 Real-time messaging & push notifications</li>
          <li>🔐 Secure authentication with OAuth integration</li>
          <li>⚡ <strong>40% performance improvement</strong> with optimized queries</li>
          <li>🧪 <strong>95% code coverage</strong> with comprehensive testing</li>
        </ul>
      </td>
      
      <td width="50%" valign="top">
        <div align="center">
          <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Shopping%20Cart.png" alt="Shopping Cart" width="60" height="60" />
          <h3>🛒 E-commerce Shop Application</h3>
          <p align="center">
            <a href="https://github.com/joee231/ShopApp">
              <img src="https://custom-icon-badges.demolab.com/badge/VIEW-CODE-3B82F6?style=for-the-badge&logo=github&logoColor=white&labelColor=1a1b27" alt="Source Code" />
            </a>
          </p>
        </div>
        
        <p align="center"><strong>🔥 Flutter • Firebase • GraphQL</strong></p>
        ...
        <ul>
          <li>🛍️ Comprehensive e-commerce solution</li>
          <li>📱 Adaptive UI for multiple screen sizes</li>
          <li>⚡ <strong>50% reduced network requests</strong> with GraphQL</li>
          <li>🏗️ BLoC architecture for complex business logic</li>
          <li>🧪 <strong>90% test coverage</strong> with automated testing</li>
        </ul>
      </td>
    </tr>
  </table>
